@extends('layouts.panel', ['title' => 'Rejected Withdrawal Requests'])

@section('content')
<div class="mb-6 flex justify-between items-end">
    <div>
        <h1 class="text-2xl font-black text-slate-900 uppercase">Rejected Withdrawal Requests</h1>
        <p class="text-slate-500 text-xs font-medium uppercase tracking-widest opacity-70">View all rejected withdrawal requests from fundraisers</p>
    </div>
