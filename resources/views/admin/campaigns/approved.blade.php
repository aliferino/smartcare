@extends('layouts.panel', ['title' => 'Approved Campaigns'])

@section('content')
<div class="mb-6 flex justify-between items-end">
    <div>
        <h1 class="text-2xl font-black text-slate-900 uppercase">Approved Campaigns</h1>
        <p class="text-slate-500 text-xs font-medium uppercase opacity-70">Actively running fundraising programs.</p>
    </div>
...
<div id="table-container" class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
    @include('admin.campaigns._table', ['campaigns' => $campaigns, 'context' => 'approved'])
</div>
