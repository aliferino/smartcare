@extends('layouts.panel', ['title' => 'Rejected Citizens'])

@section('content')
<div class="mb-6 flex justify-between items-end">
    <div>
        <h1 class="text-2xl font-black text-slate-900 uppercase">Rejected KYC Submissions</h1>
        <p class="text-slate-500 text-xs font-medium uppercase opacity-70">View all rejected citizen submissions.</p>
    </div>
...
<div id="table-container" class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
    @include('admin.citizen._table', ['citizens' => $citizens, 'context' => 'rejected'])
</div>
