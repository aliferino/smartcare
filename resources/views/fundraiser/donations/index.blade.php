@extends('layouts.panel', ['title' => 'My Donations'])

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-black text-slate-900 uppercase">Donation Records</h1>
    <p class="text-slate-500 text-xs font-medium uppercase tracking-widest opacity-70">Monitor contributions to your campaigns</p>
</div>
...
<div id="table-container" class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
    @include('fundraiser.donations._table', ['donations' => $donations])
</div>

@include('fundraiser.donations._modal')
...
<script>
    ...
    $(document).on('click', '.pagination-link', function (e) {
        ...
        $.ajax({
            url: '{{ route("fundraiser.donations") }}',
            type: 'GET',
            ...
            success: function (data) {
                ...
                // Keep URL clean
                history.replaceState(null, '', '{{ route("fundraiser.donations") }}');
            }
        });
    });
</script>
